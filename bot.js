...
var prefix = "$"
var adminprefix = '&'
const developers = ["353122825177137154","id"]
  ...
  client.on("message", message => {
    if (message.content === "$help") {
     const embed = new Discord.RichEmbed()
       ...
       $i | لمعرفة عدد انفايتاتك
       $new | لإنشاء تكت
       $g  |  لإعداد قيفاواي
       &j | لتغيير اسم البوت
       &ava | لتغيير صورة البوت
       &ls | لتفعيل الليستنق للبوت
       &wt| لتفعيل الواتشينق للبوت
       &s | لتفعيل الستريمنق للبوت
       &pl | لتفعيل البلاينق للبوت
...
/////
client.login('NTgxNzYzMzY3OTQ2MDI3MDA4.XOkAgQ.Y4zfI-AOH8GHsMmhuXPKTuSCbsY');
